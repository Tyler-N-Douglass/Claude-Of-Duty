...
const MK4: WeaponEntry = {
  ...
  visual: {
    ...
    handguard: 'mlok', handguardLength: 0.190, handguardRadius: 0.0205, handguardSlots: 5,
    muzzle: 'birdcage',
    ...
    opticHeight: 0.056,
    adsDistance: 0.248,
    hipPos: [0.112, -0.106, -0.150],
    hipRot: [-2.2 * DEG, -4.2 * DEG, 3.4 * DEG],
    polymerColor: 0x3b3832,
    metalColor: 0x7d7970,
    accentColor: 0x353331,
...
const VKS9: WeaponEntry = {
  ...
  visual: {
    ...
    handguard: 'vented', handguardLength: 0.110, handguardRadius: 0.0182, handguardSlots: 4,
    muzzle: 'comp',
    ...
    opticHeight: 0.060,
    adsDistance: 0.215,
    hipPos: [0.108, -0.098, -0.135],
    hipRot: [-1.8 * DEG, -4.8 * DEG, 3.8 * DEG],
    polymerColor: 0x373431,
    metalColor: 0x76736d,
    accentColor: 0x31302e,
...
const M16BR: WeaponEntry = {
  ...
  visual: {
    ...
    handguard: 'slab', handguardLength: 0.205, handguardRadius: 0.0210, handguardSlots: 6,
    muzzle: 'birdcage',
    ...
    opticHeight: 0.054,
    adsDistance: 0.275,
    hipPos: [0.114, -0.110, -0.156],
    hipRot: [-2.4 * DEG, -3.8 * DEG, 3.2 * DEG],
    polymerColor: 0x4d452f,
    metalColor: 0x7a766c,
    accentColor: 0x36332d,
...
const KV800: WeaponEntry = {
  ...
  visual: {
    ...
    handguard: 'slab', handguardLength: 0.185, handguardRadius: 0.0225, handguardSlots: 3,
    muzzle: 'brake',
    ...
    opticHeight: 0.064,
    adsDistance: 0.235,
    hipPos: [0.128, -0.116, -0.168],
    hipRot: [-2.6 * DEG, -3.6 * DEG, 3.0 * DEG],
    polymerColor: 0x4a4c3c,
    metalColor: 0x75726c,
    accentColor: 0x30312e,
...
const M870: WeaponEntry = {
  ...
  visual: {
    ...
    opticHeight: 0.050,
    adsDistance: 0.230,
    hipPos: [0.118, -0.110, -0.150],
    hipRot: [-2.4 * DEG, -4.2 * DEG, 3.6 * DEG],
    polymerColor: 0x4d382a,
    metalColor: 0x716f68,
    accentColor: 0x322f2a,
...
const P226: WeaponEntry = {
  ...
  visual: {
    ...
    opticHeight: 0.048,
    adsDistance: 0.290,
    hipPos: [0.098, -0.126, -0.180],
    hipRot: [-3.0 * DEG, -5.4 * DEG, 4.2 * DEG],
    polymerColor: 0x363434,
    metalColor: 0x75726d,
    accentColor: 0x2e2d2d,
